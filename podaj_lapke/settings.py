"""
Django settings for podaj_lapke project.
...
WSGI_APPLICATION = "podaj_lapke.wsgi.application"
...
CORS_ALLOWED_ORIGIN_REGEXES = env.list(
    "CORS_ALLOWED_ORIGIN_REGEXES", default=[r"http://localhost:\d{4}"]
)
